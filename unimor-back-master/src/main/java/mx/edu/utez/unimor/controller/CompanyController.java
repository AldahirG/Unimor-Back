...
public class CompanyController {
    ...
    public Object findAllMobile(@RequestParam Optional<Integer> page) {
        return companyService.findAllByStatus(PageRequest.of(0, page.orElse(8)));
    }
    ...
    public ResponseEntity<Resource> image(@PathVariable String img) throws IOException {
        final ByteArrayResource inputStream = new ByteArrayResource(Files.readAllBytes(Paths.get(
                ResponseMessage.FILES_LOCATION + img
        )));
